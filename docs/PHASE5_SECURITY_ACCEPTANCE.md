...
- Latest v0.6.0 verification on 2026-08-01: Sidecar 80, Contracts 7, Application 20, Desktop 262, and Named Pipe integration 1 all pass with zero build warnings/errors. Sidecar handshake, heartbeat, restart, and cleanup smoke also passes. The previous five-restart follow-up soak measured 21,094,400 bytes of private-memory growth and 80 handles, within the 128 MiB/256 acceptance limits.
