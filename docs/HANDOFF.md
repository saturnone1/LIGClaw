...
- C-5 transcript에서 사용자가 선택한 답변 글만 Windows 로컬 음성으로 읽는 TTS. 20,000자 경계, 합성 준비 중·재생 중 같은 버튼 즉시 중지, 완료·실패·창 종료 buffer 폐기. 자동 읽기·방해 금지는 별도 opt-in 후속
