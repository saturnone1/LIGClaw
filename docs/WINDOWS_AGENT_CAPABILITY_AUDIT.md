...
| 화면·OCR·음성 | 부분 | ADR 0033 개인정보 경계, `PreparedSensitiveContext` 상한·identity·2분 만료·zeroing, 실제 이미지/OCR preview·선택 마스킹·취소 기본값·OCR-only export | Windows 시스템 picker 1회 캡처→로컬 OCR→STT/TTS 순서로 수직 검증 |
